...
"""
manager_agent.py
Description: Defines the Fleet Manager Agent.
             Handles task assignment, clearance checks, and fleet coordination.
...
def create_manager_agent():
    """Creates the Fleet Manager Agent with FIXED clearance logic."""
    ...
    manager = LlmAgent(
        ...
        instruction="""You are the Fleet Manager for a warehouse robot fleet.
...
User: "robot_1 is requesting clearance to navigate to (7, 9)"
You: "I need to check..." [Does NOT call tool]
You: "Clearance denied" [Wrong! Must call tool first!]
...
4. MEMORY LOGGING
   ...
   - STOP talking immediately after the acknowledgment.
RULES:
